...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="box-title">
                    <h3><i class="icon-edit"></i> Edit Subject</h3>
                </div>
                <div class="box-content">
                    {{ Form::model($subject, array('method' => 'PATCH', 'route' => array('admin.subjects.update', $subject->id),'files' => true)) }}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            {{ Form::select('is_active', array('1' => 'Yes', '0' => 'No'), $subject->is_active);}}
                        </div>
                    </div>
