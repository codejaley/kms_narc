		...
		<div class="login-body">
          ...
          <form action="{{ action('RemindersController@postReset') }}" method="POST">
				...
				<div class="form-group">
                                        <input type="email" required class="form-control" id="lg_password" name="email" placeholder="Email">
                     </div>
					<div class="form-group">
                             <label for="lg_password" class="sr-only">Password</label>
                             <input type="password" required class="form-control" id="lg_password" name="password" placeholder="Enter password">
                      </div>
                     <div class="form-group">
                                        <label for="lg_password" class="sr-only">Password Confirmation</label>
                                        <input type="password" required class="form-control" id="lg_password" name="password_confirmation" placeholder="Enter password again">
                     </div>
